...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <form method="POST" action="../backends/add_product.php" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <select class="form-select" name="category" aria-label="Select category">
                            ...
                            <?php include '../backends/gat_category_admin.php' ?>
                        </select>
                    ...
                    <div class="mb-3">
                        <label for="mainPic" class="form-label">Add the main pic</label>
                        <input class="form-control" type="file" name="main_pic" id="mainPic">
                    </div>
                    <div class="mb-3">
                    ...
                    <button class="btn btn-outline-primary w-100 m-2" type="submit" name="submit">ADD</button>
